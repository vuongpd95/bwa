...
LOBJS=		utils.o kthread.o kstring.o ksw.o bwt.o bntseq.o bwa.o bwamem.o bwamem_pair.o bwamem_extra.o malloc_wrap.o \
			rope.o rle.o is.o bwtindex.o se_kernel.o
AOBJS=		fastmap.o
PROG=		bwa
...
bwa:libbwa.a $(AOBJS) main.o
		$(CC) $(CFLAGS) $(DFLAGS) $(AOBJS) main.o -o $@ -L. -L/usr/local/cuda/lib64 -lbwa $(LIBS)
...
se_kernel.o: se_kernel.h bwamem.h utils.h kvec.h ksw.h
...
bwa.o: kseq.h
bwamem.o: kstring.h malloc_wrap.h bwamem.h bwt.h bntseq.h bwa.h ksw.h kvec.h se_kernel.h
bwamem.o: ksort.h utils.h kbtree.h se_kernel.h
